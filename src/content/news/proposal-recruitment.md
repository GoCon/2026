...
Go Conference は毎年テーマを掲げて開催しており、2026 年は [**"Go Far, Go Together"**](https://gocon.jp/2026/news/lunch-drink-sponsor/) を掲げています。これまでの審査基準は、その年のテーマとは独立した汎用的な観点でした。もちろんそれ自体に問題があったわけではありませんが、テーマに込めた想いと審査基準が地続きになっていることで、運営が大切にしたい方向性をより誠実に応募者の皆様にお伝えできると考えました。「Go Conference 2026 のテーマに則しているか」というカテゴリを新設したのは、その表れです。
